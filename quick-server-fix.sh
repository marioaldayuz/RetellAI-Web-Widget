...
echo "<link rel=\"stylesheet\" href=\"https://YOUR_DOMAIN/retell-widget.css\">"
echo "<script src=\"https://YOUR_DOMAIN/retell-widget.js\"></script>"
echo "<script>"
echo "  const widget = new RetellWidget({"
echo "    agentId: 'your_agent_id_here',  // Replace with your agent ID"
